...
struct PixelEventsCheckoutContactInfoSubmittedData {
    var checkout: Checkout
}

struct PixelEventsCheckoutShippingInfoSubmittedData {
    var checkout: Checkout
}

struct PixelEventsCheckoutStartedData {
    var checkout: Checkout
}
...
struct PixelEventsProductRemovedFromCartData {
    var cartLine: CartLine?
}
...
struct PixelEventsProductViewedData {
    var productVariant: ProductVariant
}
...
public struct PixelEventsProductRemovedFromCart {
    var clientId: ClientId
    var context: Context
...
public struct PixelEventsProductViewed {
    var clientId: ClientId
    var context: Context
